...
functions, and 97.78% lines. The repository quality gate has 281 passing tests with 96.68%
statements, 91.63% branches, 98.61% functions, and 96.64% lines. `pnpm check`, `pnpm build`, and
`git diff --check` pass.
