...
functions, and 97.82% lines. The repository quality gate has 217 passing tests with 97.41%
statements, 92.38% branches, 99.47% functions, and 97.35% lines. `pnpm check`, `pnpm build`, and
`git diff --check` pass.
