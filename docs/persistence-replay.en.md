...
functions, and 97.82% lines. The repository quality gate has 218 passing tests with 97.37%
statements, 92.46% branches, 99.47% functions, and 97.31% lines. `pnpm check`, `pnpm build`, and
`git diff --check` pass.
