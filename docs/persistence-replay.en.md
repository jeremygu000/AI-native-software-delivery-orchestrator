...
functions, and 97.78% lines. The repository quality gate has 275 passing tests with 96.67%
statements, 91.84% branches, 98.60% functions, and 96.64% lines. `pnpm check`, `pnpm build`, and
`git diff --check` pass.
