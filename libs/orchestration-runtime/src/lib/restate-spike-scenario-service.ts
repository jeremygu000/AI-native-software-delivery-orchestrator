...
export interface RestateSpikeScenarioServiceDependencies {
...
export const createRestateSpikeScenarioService = (
  dependencies: RestateSpikeScenarioServiceDependencies
): RestateSpikeScenarioService => {
